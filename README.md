...
(Note: Based on the evaluation, the Decision Tree model achieved the highest accuracy of \\\~98.6% and was saved as `diabetes\\\_model.pkl` for deployment in the FastAPI application.)
